...
### SpringBoot对比SpringCloud

- 分工不同
    - SpringBoot是一个基于Spring的快速开发框架，在微服务开发中，主要是快速方便的开发单个微服务
    - SpringCloud 专注于全局微服务的协调和治理工作。SpringCloud 相当于微服务的大管家，一个个微服务管理起来，并为它们提供各种服务。
- SpringCloud基于SpringBoot实现，提供一系列starter
- 依赖项不同
    - Spring Boot 属于一种轻量级的框架，依赖项较少
    - Spring Cloud 工程往往需要大量的依赖项
- SpringCloud 不能脱离 SpringBoot 单独运行
